...
class JobseekerCodeVC: UIViewController {

    private let segueJobseekerSignupTwoVC = "JobseekerSignupTwoVC"
    var completion: (() -> Void)?
...
//        return
        ...
        if (code1.text != "" || code1.text != "X") && (code2.text != "" || code2.text != "X") && (code3.text != "" || code3.text != "X") && (code4.text != "" || code4.text != "X") {
            ...
            self.hud.dismiss(animated: true)
            AlertService.shared.alert(in: self, "Please insert code received on the given email address")
