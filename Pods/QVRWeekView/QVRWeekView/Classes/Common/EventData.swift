...
open class EventData: CustomStringConvertible, Equatable, Hashable {
    ...
    open func getDisplayString(withMainFont mainFont: UIFont = TextVariables.eventLabelFont, andInfoFont infoFont: UIFont = TextVariables.eventLabelInfoFont) -> NSAttributedString {
        ...
        df.dateFormat = "HH:mm"
        let mainFontAttributes: [NSAttributedStringKey: Any] = [NSAttributedString.Key(rawValue: NSAttributedStringKey.font.rawValue): mainFont, NSAttributedString.Key(rawValue: NSAttributedStringKey.foregroundColor.rawValue): TextVariables.eventLabelTextColor.cgColor]
        let infoFontAttributes: [NSAttributedStringKey: Any] = [NSAttributedString.Key(rawValue: NSAttributedStringKey.font.rawValue): infoFont, NSAttributedString.Key(rawValue: NSAttributedStringKey.foregroundColor.rawValue): TextVariables.eventLabelTextColor.cgColor]
