...
class DayViewCell: UICollectionViewCell, CAAnimationDelegate {
    ...
    private func makePreviewLayer(at position: CGPoint) {
        ...
        let mainFontAttributes: [NSAttributedStringKey: Any] = [NSAttributedString.Key(rawValue: NSAttributedStringKey.font.rawValue): TextVariables.eventLabelFont, NSAttributedString.Key(rawValue: NSAttributedStringKey.foregroundColor.rawValue): TextVariables.eventLabelTextColor.cgColor]
