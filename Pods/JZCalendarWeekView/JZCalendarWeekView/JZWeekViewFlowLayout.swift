...
open class JZWeekViewFlowLayout: UICollectionViewFlowLayout {
    ...
    open var maxSectionHeight: CGFloat {
        let someHeight = hourHeight * 24
        let someValue = columnHeaderHeight + someHeight + contentsMargin.top + contentsMargin.bottom + allDayHeaderHeight
        return someValue // columnHeaderHeight + hourHeight * 24 + contentsMargin.top + contentsMargin.bottom + allDayHeaderHeight
